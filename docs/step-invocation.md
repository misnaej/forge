...
| Pure in-process check | No external tool at all — plain Python over the repo tree / git metadata | `env_sync`, `plugin_sync`, `release_tag_guard`, `vendored_integrity` |
