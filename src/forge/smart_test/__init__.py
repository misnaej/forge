...
analysis only; no runtime instrumentation. See ``docs/release-process``
sibling FOUNDATION §17 for the depth model and the speed/coverage
trade-off.
...
- :mod:`forge.smart_test.runner` — union selection + a single ``pytest``
  invocation per depth, with import-cache hygiene.
