...
def sync_forge_docs(repo_root: Path, *, check_only: bool = False) -> bool:
    ...
    Returns:
        ...
        False when already in sync or self-skipped.
    """
...
def main() -> int:
    ...
    docs_changed = sync_forge_docs(root, check_only=args.check)
